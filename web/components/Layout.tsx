...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange, error, onErrorDismiss }) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center p-4 transition-colors duration-200">
      {/* Mobile Frame Container */}
      <div className="relative w-full max-w-md h-[calc(100vh-2rem)] bg-white dark:bg-gray-900 rounded-[3rem] shadow-2xl border-8 border-gray-800 dark:border-gray-700 overflow-hidden flex flex-col">
        {/* Top Notch */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-40 h-6 bg-gray-800 dark:bg-gray-700 rounded-b-2xl z-50"></div>
        
        {/* Device Inner Frame */}
        <div className="h-full bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col overflow-hidden transition-colors duration-200">
          {/* Error Banner */}
          {error && (
